...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/github-activity-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15205&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/github-activity-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `github-activity` can be installed with:

```
conda install github-activity
```

It is possible to list all of the versions of `github-activity` available on your platform with:
